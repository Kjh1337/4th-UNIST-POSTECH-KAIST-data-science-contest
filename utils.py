...
if __name__ == "__main__":
    results_dir = "/home/elicer/FinanceRAG/results"
    dataset_dir = "/home/elicer/FinanceRAG/dataset"
    
    print("Starting post-processing...")
    post_process(results_dir, dataset_dir)
    print("Post-processing completed. Results saved to final.csv")